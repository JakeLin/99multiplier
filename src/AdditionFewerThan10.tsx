...
const AdditionFewerThan10 = () => {
  ...
  return (
    <Container>
      <SubContainer>
        <ResultRow>
          Total: {passedNumber + failedNumber} | {passedNumber} passed vs. {failedNumber} failed. Time spent: {timePassed}
        </ResultRow>
        <FormulaRow>
...
export default AdditionFewerThan10;
